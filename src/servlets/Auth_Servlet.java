...
/**
 * Servlet implementation class Auth_Servlet
 */
...
public class Auth_Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String acmdp=(String) session.getAttribute("mdp");
		String erreur="";
		if(email.equals(acemail)&&password.equals(acmdp))
		{
		...
		{
			erreur= "compte inconnue ou inexistant";
